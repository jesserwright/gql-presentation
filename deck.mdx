...
Database ➡ Server ➡ <span style={{color: '#e535ab'}}>**_GraphQL_**</span> ➡ Client ➡ UI
...
- Declarative like SQL so you don’t have to remember what you're asking for... (as with REST)
